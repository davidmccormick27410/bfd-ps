...
$queryStatment = "SELECT meter_id, mread_prop_name, mread_prop_value FROM meter_reading_properties" #Be careful not to terminate it with a semicolon, it doesn't like it

$destinationInstance = "localhost"
$destinationDB = "BFD"
$destinationSchema ="Staging"
$destinationTable = "MM_METER_READING_PROPERTIES"

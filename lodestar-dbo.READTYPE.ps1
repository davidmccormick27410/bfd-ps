...
$queryStatment = "SELECT uidreadtype, readtypecode, readtypename, lsuser, lstime from readtype" #Be careful not to terminate it with a semicolon, it doesn't like it

$destinationInstance = "localhost"
$destinationDB = "Lodestar"
$destinationSchema ="dbo"
$destinationTable = "READTYPE"

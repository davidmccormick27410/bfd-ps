...
$queryStatment = "SELECT invlineitemnum, uidinvoice, meterid, servicetype, meterreadstart, meterreadstop, description, startmeterread, stopmeterread, metermultiplier, usage, electricblock, unitscharged, usagepercentage, rate, amount, lsuser, lstime from invlineitem" #Be careful not to terminate it with a semicolon, it doesn't like it

$destinationInstance = "localhost"
$destinationDB = "Lodestar"
$destinationSchema ="dbo"
$destinationTable = "INVLINEITEM"

...
$queryStatment = "SELECT uidaccount, uiddirectory, faxflag, contacttype, lsuser, lstime from acctdirectory" #Be careful not to terminate it with a semicolon, it doesn't like it

$destinationInstance = "localhost"
$destinationDB = "Lodestar"
$destinationSchema ="dbo"
$destinationTable = "ACCTDIRECTORY"

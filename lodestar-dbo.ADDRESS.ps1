...
$queryStatment = "SELECT uidaddress, address1, address2, address3, city, state, zip, county, country, lsuser, lstime from address" #Be careful not to terminate it with a semicolon, it doesn't like it

...
$queryStatment = "SELECT uidservicepoint, uidmarket, servicepointid, servicepointname, uidpremise, lsuser, lstime, grosssqfootage, uidaddress from lsservicepoint" #Be careful not to terminate it with a semicolon, it doesn't like it

$destinationInstance = "localhost"
$destinationDB = "Lodestar"
$destinationSchema ="dbo"
$destinationTable = "LSSERVICEPOINT"

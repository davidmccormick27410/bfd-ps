...
$queryStatment = "SELECT uidbillhistory, uidaccount, starttime, stoptime, billmonth, billtime, readdate, userspecifiedstop, kwh, uidbillcode, profilestatusflag, 
lsuser, lstime, rebillreasoncode, customerid, accountclasscode, frsnum, sqfootage from billhistory" #Be careful not to terminate it with a semicolon, it doesn't like it

$destinationInstance = "localhost"
$destinationDB = "Lodestar"
$destinationSchema ="dbo"
$destinationTable = "BILLHISTORY"

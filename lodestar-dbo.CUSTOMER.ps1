...
$queryStatment = "SELECT uidcustomer, customerid, name, summarybill, uidacctmgrdir, uidcontactdir, acctmgrfaxflag, contactfaxflag, creditscore, owner, lsuser, lstime, uidcustomerclass from customer" #Be careful not to terminate it with a semicolon, it doesn't like it

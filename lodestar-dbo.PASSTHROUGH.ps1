...
$queryStatment = "SELECT passthroughnum, uidsvcprovider, uidaccount, uidmeter, stopreading, demand, charges, lsuser, lstime, onetimecharge, billmonth,
 appliedon, servicetypecode, description, stopreadingtime, consumption from passthrough" #Be careful not to terminate it with a semicolon, it doesn't like it

$destinationInstance = "localhost"
$destinationDB = "Lodestar"
$destinationSchema ="dbo"
$destinationTable = "PASSTHROUGH"

...
$queryStatment = "SELECT uidtransaction, uidaccount, transactionno, transactionid, transactiontime, revenuemonth, userid, canceltime, cancelrevenuemonth, canceluserid, 
cancelreasoncode, chargeorcredit, amount, balance, billedorpaiddate, duedate, uidreceivabletype, uidchargetype, uidrateform, ratecode, opcocode, juriscode, uidbillhistory, 
billcycledate, uidtxfrtotrans, uidtxfrfromtrans, uidpayment, uidserviceplan, uidbudgetplan, note, cancelnote, statementdate, debitacctid, creditacctid, costcenterid,
canceldebitacctid, cancelcreditacctid, cancelcostcenterid, invoiceid, invoicedate, uidsubaccount, cancelstmntdate, cancelinvoiceid, cancelinvoicedate,uidinstallmentplan,
uiddeposit, applicationmethod, uidbatchtrans, uidbatchcancel, disputeflg from lstransaction" #Be careful not to terminate it with a semicolon, it doesn't like it

$destinationInstance = "localhost"
$destinationDB = "Lodestar"
$destinationSchema ="dbo"
$destinationTable = "LSTRANSACTION"

...
$queryStatment = "SELECT uidmeter, meterid, manufacturer, serialno, uninumber, lsuser, lstime from meter" #Be careful not to terminate it with a semicolon, it doesn't like it

$destinationInstance = "localhost"
$destinationDB = "Lodestar"
$destinationSchema ="dbo"
$destinationTable = "METER"

...
$queryStatment = "SELECT uidaccount, uidcustomer,  accountid, starttime, stoptime, opcocode, juriscode, name, sic, accountstatuscode,revenuecode, billingmodeflag, printdetail, 
fulldaybill, prewindow, postwindow, edi, regioncode, currencycode, owner, accounttypecode, uidmarketparticipant, lsuser, lstime, spclhandlecode, uidgasaccttype, frsnum,
printacctinvoice, printsummaryinvoice, uidfrsdept, uidfundingtype, sqfootage, uidaccountclass, uidorganization, indclassificationcode from account" #Be careful not to terminate it with a semicolon, it doesn't like it

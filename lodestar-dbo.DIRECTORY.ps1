...
$queryStatment = "SELECT uiddirectory, directorycode, name, phone1, phone2, fax, pager, email, title, nameoffile, prefix, firstname, middleinitial, lastname, suffix, uidaddress, lsuser, lstime from directory" #Be careful not to terminate it with a semicolon, it doesn't like it

$destinationInstance = "localhost"
$destinationDB = "Lodestar"
$destinationSchema ="dbo"
$destinationTable = "DIRECTORY"

...
$queryStatment = "SELECT transactionid, canceltransid, transtypecode, description, isdefault, weight, durationdays, lsuser, lstime from transactionid" #Be careful not to terminate it with a semicolon, it doesn't like it

$destinationInstance = "localhost"
$destinationDB = "Lodestar"
$destinationSchema ="dbo"
$destinationTable = "TRANSACTIONID"

...
$queryStatment = "SELECT uidreceivabletype, receivabletypename, description, lsuser, lstime from receivabletype" #Be careful not to terminate it with a semicolon, it doesn't like it

$destinationInstance = "localhost"
$destinationDB = "Lodestar"
$destinationSchema ="dbo"
$destinationTable = "RECEIVABLETYPE"

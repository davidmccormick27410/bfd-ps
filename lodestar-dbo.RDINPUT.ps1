...
$queryStatment = "SELECT rdinputnum, bfexpsteam, bfexpelec, bvexpsteam, nbvexpelec, drcsteam, drcelec, marginalsteamrate, incnonchillsteam, incchillsteam, incelec, 
ratediffelec, syslevelsteamusage, summerdemandcost, winterdemandcost, lsuser, lstime, incsteamdemand, tieronepct, tiertwopct, totelecusage,
incdelecdemand, bfexpcw, bvexpcw, drccw, inccw from rdinput" #Be careful not to terminate it with a semicolon, it doesn't like it

$destinationInstance = "localhost"
$destinationDB = "Lodestar"
$destinationSchema ="dbo"
$destinationTable = "RDINPUT"

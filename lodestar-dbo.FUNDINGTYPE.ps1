...
$queryStatment = "SELECT uidfundingtype, fundingtypecode, fundingtypename, lsuser, lstime from fundingtype" #Be careful not to terminate it with a semicolon, it doesn't like it

$destinationInstance = "localhost"
$destinationDB = "Lodestar"
$destinationSchema ="dbo"
$destinationTable = "FUNDINGTYPE"

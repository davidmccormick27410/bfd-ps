...
$queryStatment = "SELECT uidsvcprovider, svcprovidercode, svcprovidername, lsuser, lstime from svcprovider" #Be careful not to terminate it with a semicolon, it doesn't like it

$destinationInstance = "localhost"
$destinationDB = "Lodestar"
$destinationSchema ="dbo"
$destinationTable = "SVCPROVIDER"

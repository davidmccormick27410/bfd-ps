...
$queryStatment = "SELECT uidbillhistory, uidbilldeterminant, val, lsuser, lstime, reported, reportdate from billhistoryvalue" #Be careful not to terminate it with a semicolon, it doesn't like it

$destinationInstance = "localhost"
$destinationDB = "Lodestar"
$destinationSchema ="dbo"
$destinationTable = "BILLHISTORYVALUE"

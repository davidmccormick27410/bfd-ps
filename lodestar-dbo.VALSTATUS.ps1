...
$queryStatment = "SELECT uidvalstatus, valstatuscode, valstatusname, lsuser, lstime from valstatus" #Be careful not to terminate it with a semicolon, it doesn't like it

$destinationInstance = "localhost"
$destinationDB = "Lodestar"
$destinationSchema ="dbo"
$destinationTable = "VALSTATUS"

...
$queryStatment = "SELECT uidmeterhistory, uidmeter, starttime, servicetypecode, uidaccount, uidserviceplan, uidpremise, stoptime, numdials, metermultiplier, meteroffset
, endusecode, uidservicepoint, lsuser, lstime, uidsvcprovider, uidowasapipesz, passthroughflg, allocpct, ratedetflg, demandflg from meterhistory" #Be careful not to terminate it with a semicolon, it doesn't like it

$destinationInstance = "localhost"
$destinationDB = "Lodestar"
$destinationSchema ="dbo"
$destinationTable = "METERHISTORY"

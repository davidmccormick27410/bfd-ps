...
$queryStatment = "SELECT uidservicepoint, uidaccount, starttime, stoptime, lsuser, lstime from lssrvcptacct" #Be careful not to terminate it with a semicolon, it doesn't like it

$destinationInstance = "localhost"
$destinationDB = "Lodestar"
$destinationSchema ="dbo"
$destinationTable = "LSSRVCPTACCT"

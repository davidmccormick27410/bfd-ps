...
$queryStatment = "SELECT meter_id, meter_sn, location_id, status_code, monthly_reading_type FROM meter_info" #Be careful not to terminate it with a semicolon, it doesn't like it

$destinationInstance = "localhost"
$destinationDB = "BFD"
$destinationSchema ="Staging"
$destinationTable = "MM_METER_INFO"

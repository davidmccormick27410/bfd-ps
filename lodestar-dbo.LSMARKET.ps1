...
$queryStatment = "SELECT uidmarket, marketid, servicetype, lsuser, lstime from lsmarket" #Be careful not to terminate it with a semicolon, it doesn't like it

$destinationInstance = "localhost"
$destinationDB = "Lodestar"
$destinationSchema ="dbo"
$destinationTable = "LSMARKET"

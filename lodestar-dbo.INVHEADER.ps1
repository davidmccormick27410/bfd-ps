...
$queryStatment = "SELECT uidinvoice, invoiceid, accountid, frsnum, customerid, billdate, duedate, invoiceamount, pastdue, payment, previnvamt, address, city, state, postalcode, lsuser, lstime, invoicetype from invheader" #Be careful not to terminate it with a semicolon, it doesn't like it

$destinationInstance = "localhost"
$destinationDB = "Lodestar"
$destinationSchema ="dbo"
$destinationTable = "INVHEADER"

...
$queryStatment = "SELECT uidfrsdept, frsdeptnum, frsdeptname, lsuser, lstime from frsdept" #Be careful not to terminate it with a semicolon, it doesn't like it

$destinationInstance = "localhost"
$destinationDB = "Lodestar"
$destinationSchema ="dbo"
$destinationTable = "FRSDEPT"

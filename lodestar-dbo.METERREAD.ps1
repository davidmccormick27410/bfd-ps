...
$queryStatment = "SELECT uidmeter, meterreadtime, uidbilldeterminant, stopreadtime, stopreading, startreadtime, startreading, peaktime, peakvalue, meterreadmonth,
thermfactor, lsuser, lstime, consumption, uidvalstatus, uidreadtype from meterread" #Be careful not to terminate it with a semicolon, it doesn't like it

$destinationInstance = "localhost"
$destinationDB = "Lodestar"
$destinationSchema ="dbo"
$destinationTable = "METERREAD"

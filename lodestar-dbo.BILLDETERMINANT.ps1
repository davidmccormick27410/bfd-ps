...
$queryStatment = "SELECT uidbilldeterminant, billdetermcode, identifier, billdetermname, uomcode, billhistcolname, aggregate, billdetermtypecode, lsuser, lstime from billdeterminant" #Be careful not to terminate it with a semicolon, it doesn't like it

$destinationInstance = "localhost"
$destinationDB = "Lodestar"
$destinationSchema ="dbo"
$destinationTable = "BILLDETERMINANT"

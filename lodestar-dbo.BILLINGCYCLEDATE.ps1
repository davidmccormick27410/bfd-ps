...
$queryStatment = "SELECT uidbillingcycle, readdate, billmonth, lsuser, lstime from billingcycledate" #Be careful not to terminate it with a semicolon, it doesn't like it

$destinationInstance = "localhost"
$destinationDB = "Lodestar"
$destinationSchema ="dbo"
$destinationTable = "BILLINGCYCLEDATE"
